...
public class BankingSystem {
    public static void main(String[] args)
    {
        ...
        SavingAccount sa = new SavingAccount("AK123",56000.365,5.7f,LocalDate.now());
        CurrentAccount cr = new CurrentAccount("Ak123", 56000.365, LocalDate.now(), 60000.369, LocalDate.of(2025, 11, 13));
